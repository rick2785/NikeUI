...
//  NikeShoeUI
//
//  Created by RJ Hrabowskie on 9/13/20.
//
    ...
    var body: some View {
        VStack {
            ...
            ScrollView(UIScreen.main.bounds.height < 750 ? .vertical : .init(), showsIndicators: false) {
                VStack {
                    HStack {
                        Text("Nike Air Huarache For \(gender)")
                            .font(.title2)
                            .fontWeight(.heavy)
                            .foregroundColor(black)
                        Spacer(minLength: 0)
                    ...
                    VStack(alignment: .leading, spacing: 5) {
                        Text("The Nike Air Huarache '07 WW is the b-ball OG with the look you know best: crisp leather, bold colors and the perfect amount of flash to make you shine. Featuring Nike Worldwide graphics throughout, it let's you celebrate the unity of sport in legendary style.")
